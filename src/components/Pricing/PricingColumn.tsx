    ...
    >
      <div className="p-6 border-b border-border rounded-t-xl">
        ...
        <button
          ...
          className={clsx(
            "w-full py-3 px-4 rounded-full text-white font-semibold transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2",
            {
              "bg-primary hover:bg-primary/90": highlight,
